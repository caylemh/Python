...
ax.plot(dates, lows, c='violet', alpha=0.6)
plt.fill_between(dates, highs, lows, facecolor='blue', alpha=0.05)

# Get weather data for San Francisco.
filename = 'data/san_francisco_2018_summary.csv'
dates, highs, lows = [], [], []
get_weather_data(filename,dates,highs,lows,date_index=2,high_index=3,low_index=5)

# Add Death Valley data to current plot.
ax.plot(dates, highs, c='yellow', alpha=0.4)
ax.plot(dates, lows, c='darkgreen', alpha=0.4)
plt.fill_between(dates, highs, lows, facecolor='blue', alpha=0.05)

# Format plot.
title = "Death Valley, Sitka & San Francisco\nDaily High and Low temperatures for 2018"
