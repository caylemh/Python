...
# USING PEP 8 GUIDELINES TO STYLE YOU CODE
# Blank lines have not been used excessively
# 80 character length in each line
#------------------------------------------------------------------------------


# Counting to Twenty - using a 'for' loop
for value in range(21):
    print(value) # Using 4 spaces for each indentation level.
...
# Threes - list the multiples of 3 from 3 to 30 with a 'for' loop to print them
